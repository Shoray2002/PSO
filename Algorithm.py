...
def minimize(costFunc, x0, constraints, num_particles, maxiter, verbose=False):
    ...
    while i < maxiter:
        if verbose:
            print(f'iter: {i:>4d}, best solution: {err_best_g:10.18f}')
        ...
        for j in range(0, num_particles):
            ...
            swarm[j].update_position(constraints)
        i += 1
